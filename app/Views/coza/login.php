...
if(isset($_SESSION['session_username'])){
    header("location:backend/examples/dashboard.html");
    exit();
}
...
<div class="container my-4">    
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        <div class="panel panel-info" style="background-color:grey;">
            <div class="panel-heading" style="text-align:center;background-color:black;color:white;">
                <div class="panel-title" style="text-align:center;">
                    <h3>Admin Coza Store</h3>
                </div>
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="loginform" class="form-horizontal" action="" method="post" role="form">       
                    ...
                    <div style="margin-top:10px;display:flex;" class="form-group">
                        ...
                        <div class="col-sm-12 controls" >
                            <a href="/" class="btn btn-success" style="background-color:red;">Kembali</a>
                        </div>
                    </div>
                </form>    
            </div>                     
