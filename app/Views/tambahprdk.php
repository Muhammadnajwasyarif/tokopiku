                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive">
                                    <table class="table" style="margin-left:15px;">
                                        <tbody>
                                        <form action="<?= base_url('simpanprod')?>" method="post" name="polsek" enctype="multipart/form-data">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>: <input type="text" id="nm" name="slug" size="50"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>: <input type="text" id="nm" name="kategori" size="50"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>: <input type="text" id="nm" name="stok" size="50"></td>
                                        </tr>
                                        <tr>
                                            <td><label for="pesan" style="font-size:15px;color:black">Gambar</label></td>
                                            <td>: <input type="file" id="jml" name="image" size="50"></td>
                                        </tr>
                                        <tr>
